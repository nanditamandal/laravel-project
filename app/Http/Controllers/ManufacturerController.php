...
class ManufacturerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.showManufacturer')->with('manu',$manu);
    }
    ...
    public function create()
    {
        ...
        return view('employee.addManufacturer')->with('s',$sub);
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee.modifyManufacturer')->with('manu',$manu);
    }
