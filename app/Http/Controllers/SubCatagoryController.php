...
class SubCatagoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.showSubCatagory')->with('sc',$sc);
    }
    ...
    {
        $cat = Catagory::all();
        return view('employee.addSubCatagory')->withCat($cat);
    }
    ...
    public function store(Request $request)
    {
        ...
        $sub_catagory->created_by = session('loggedEmployee')->email;
    ...
    public function edit($id)
    {
        $sc = DB::table('sub_catagory')
                        ...
                        ->get();             
        return view('employee.modifySubCatagory')->with('sc',$sc);
    }
