...
class ProductDetailsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('employee.addProductDetails')->withValue($ganjam);
    }
    ...
    public function show()
    {
        ...
        //echo $pd;
        return view('employee.showProductDetails')->withP($pd);
    }
    ...
    public function edit($id)
    {
        ...
        //echo $pd;
        return view('employee.product_details')->withP($pd);
    }
    ...
    public function faddProductDetails(Request $request,$id)
    {
        ...
        $s = Supplier::all();
        //echo $pd;
        return view('employee.faddProductDetails')->withS($s)->withP($pd);
    }
